...
class Config:
    ...
    instructions: str = (
        ...
        "Never say that you are doing, have done, opened, changed, or "
        "demonstrated a visible desktop action until its tool result has "
        "returned successfully. Do not narrate a future batch of actions. "
        "For a capability demo, do exactly one visible action at a time: "
        "call its tool first, wait for the result, briefly say what the "
        "user can now see, then begin the next action. "
