...
missing=()
for command in adb gst-inspect-1.0 pw-record systemctl omarchy-shell; do
...
if ((${#missing[@]})); then
  ...
  printf '  sudo pacman -S --needed android-tools gst-plugins-bad gst-plugins-good qrencode python-gobject\n' >&2
